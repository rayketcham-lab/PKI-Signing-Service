...
/// OID 1.3.6.1.4.1.311.2.1.11 — SPC_STATEMENT_TYPE_OBJID
pub const OID_SPC_STATEMENT_TYPE: &[u8] = &[
    0x06, 0x0A, 0x2B, 0x06, 0x01, 0x04, 0x01, 0x82, 0x37, 0x02, 0x01, 0x0B,
];

/// OID 1.3.6.1.4.1.311.2.1.21 — SPC_INDIVIDUAL_SP_KEY_PURPOSE_OBJID
/// ("Microsoft Individual Code Signing")
pub const OID_SPC_INDIVIDUAL_SP_KEY_PURPOSE: &[u8] = &[
