...
pub mod keys;
pub mod pfx;
pub use keys::{PrivateKey, SigningCredentials};
...
pub use crate::cert::info::{
    extract_dn_string, extract_extensions_from_cert, parse_asn1_time, parse_certificate_info,
    CertificateInfo,
};
pub use crate::cert::validate::{
...
mod tests {
    ...
    fn security_regression_no_filesystem_path_in_pfx_error() {
        ...
        let result = super::pfx::load_pfx(Path::new("/nonexistent/secret/path.pfx"), "password");
